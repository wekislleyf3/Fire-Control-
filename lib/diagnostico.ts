...
export function montarDiagnostico(
  ...
  for (const eq of equipamentos) {
    ...
    if (!temVencido && calcularStatusEquipamento(eq) === "atencao") equipamentosEmAtencao++;
  }
  ...
  const equipamentosPendentes = equipamentos.filter((e) => calcularStatusEquipamento(e) !== "ok").length;
